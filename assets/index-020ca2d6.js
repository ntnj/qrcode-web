...
(function(module, exports) {
  (function(global2, factory) {
    ...
    var nevis = Nevis;
    var lite = nevis;
    var Renderer = lite.extend(function(qrious2, element2, enabled) {
      this.qrious = qrious2;
...
function instance$1($$self, $$props, $$invalidate) {
  let { value = "" } = $$props;
  let { size: size2 = 300 } = $$props;
  let target;
  let qr;
  onMount(() => {
    $$invalidate(3, qr = new QRious({ element: target, value, size: size2 }));
  });
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("size" in $$props2)
      $$invalidate(0, size2 = $$props2.size);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*qr, value*/
    12) {
      if (qr)
        $$invalidate(3, qr.value = value, qr);
    }
  };
  return [size2, target, value, qr, canvas_binding];
}
class QrCode extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$1, create_fragment$1, safe_not_equal, { value: 2, size: 0 });
  }
}
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      span = element("span");
      span.innerHTML = `Source: <a target="_blank" href="https://github.com/ntnj/qrcode-web">https://github.com/ntnj/qrcode-web</a>`;
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(main2, "class", "flex flex-col justify-center max-w-lg m-auto");
    },
    m(target, anchor) {
      insert(target, main2, anchor);
      append(main2, input_1);
      set_input_value(
        input_1,
        /*input*/
        ctx[0]
      ...
      append(main2, t0);
      mount_component(qrcode, main2, null);
      append(main2, t1);
      if (if_block)
...
function instance($$self, $$props, $$invalidate) {
  ...
  const hashchange_handler = () => $$invalidate(0, input = window.location.hash.slice(1));
  ...
  return [input, hashchange_handler, input_1_input_handler];
}
